...
public class MessageKeysGen {
    public static void main(String[] args) throws IOException {
        ...
        InputStream inputStream = new FileInputStream("myscaffold-web/src/main/resources/i18n/application-messages.properties");

        BufferedReader br = new BufferedReader(new InputStreamReader(inputStream));
        Class<?> targetClazz = MessageKeys.class;
        File output = new File("myscaffold-domain/src/main/java/"
